      ...
      <Dialog>
        ...
        <DialogContent class="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Tizimda yangi talaba hisobi yaratish
            </DialogDescription>
          </DialogHeader>
          <form @submit.prevent="addStudent">
            <div class="grid gap-4 py-4">
              ...
              <div class="grid grid-cols-4 items-center gap-4">
                <Label for="level_id" class="text-right">Daraja</Label>
                <div class="col-span-3">
                  <Select v-model="newStudent.level_id">
            ...
            <DialogFooter>
              <Button type="submit" :disabled="isLoading">
                ...
                />
                {{ isLoading ? "Yaratilmoqda..." : "Talaba yaratish" }}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
      ...
      <div class="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuLabel>Bo'yicha filtrlash</DropdownMenuLabel>
                ...
                <div class="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem @click="viewStudentGroups(student)">
...
const loadStudents = async () => {
  ...
  try {
    ...
    toast({
      title: "Xatolik",
      description: "Talabalarni yuklashda xatolik. Iltimos, qayta urinib ko'ring.",
      variant: "destructive",
    });
  } finally {
...
const updateStudent = async () => {
  ...
  try {
    ...
    toast({
      title: "Xatolik",
      description: "Talabani yangilashda xatolik. Iltimos, qayta urinib ko'ring.",
      variant: "destructive",
    });
  } finally {
...
const toggleStudentStatus = async (student: Student) => {
  try {
    ...
    toast({
      title: "Xatolik",
      description: "Talaba holatini yangilashda xatolik. Iltimos, qayta urinib ko'ring.",
      variant: "destructive",
    });
  }
};
...
const confirmDelete = async () => {
  ...
  try {
    ...
    toast({
      title: "Xatolik",
      description: "Talabani o'chirishda xatolik. Iltimos, qayta urinib ko'ring.",
      variant: "destructive",
    });
  } finally {
...
const loadCourses = async () => {
  try {
    ...
    toast({
      title: "Xatolik",
      description: "Kurslarni yuklashda xatolik. Iltimos, qayta urinib ko'ring.",
      variant: "destructive",
    });
  }
};
