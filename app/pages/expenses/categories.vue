<template>
  <div class="container py-10 space-y-6">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold tracking-tight">Xarajatlar kategoriyasi</h1>
      ...
      <CardContent class="p-0">
        ...
        <div class="flex items-center justify-between p-4">
          <div class="text-sm text-muted-foreground">
            ...
            <span class="font-medium">{{ filteredCategories.length }}</span> ta kategoriya
          </div>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Ushbu kategoriyani o'chirmoqchimisiz? Bu amalni bekor qilib bo'lmaydi.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
